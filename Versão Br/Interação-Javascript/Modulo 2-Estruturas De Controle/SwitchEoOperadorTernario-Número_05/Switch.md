...
- [Leia as condicionais If_Else primeiro !](../IfEoElse-Número_04/IfEoElse.md)

---

## Estrutura Condicional Switch e o Operador Ternário

### Switch

Você pode usar o `switch` para selecionar um de muitos blocos de código, de acordo com sua condição.
...
## Prática com o Switch

Faremos um reconhecimento de usuário através do `switch`. Apresentaremos ao usuário uma mensagem de boas-vindas. Para o programa reconhecer o usuário, teremos três senhas: uma do professor, uma do aluno e outra do administrador. No final, teremos quatro condições:

1. Caso a senha seja `"Admin478"`: O programa vai alertar que você é um administrador;
...
4. Caso não seja nenhuma dessas senhas: O programa vai alertar que você não tem uma senha válida e deverá contatar o suporte;
...
<head>
    ...
    <title>Reconhecimento de Usuário</title>
</head>
<body>
...
- [Continua no próximo capítulo](../SwitchEoOperadorTernario-Número_05/Ternario.md)
