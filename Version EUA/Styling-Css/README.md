...
Welcome to **Styling CSS**, a complete guide to learning how to style web pages with CSS!  

This module is divided into 6 modules that cover everything from basic concepts to advanced design techniques to create modern and interesting interfaces.
...
![Module 6](https://github.com/user-attachments/assets/965f8c38-44cc-4b7b-a1df-49de13cf35fc)
...
**[Clone the repository](https://github.com/seuusuario/styling-css.git).**  
Follow the modules in the suggested order for a progressive learning curve.  
...
To read these folders and files, it is recommended that **you follow the modules in order and when opening the modules, read from Number_1 onwards**, e.g. `Introductory_Concepts-Number_01`, `Inserting_Html-Number_02`, etc., so you don’t get lost. Because each of these folders and files are connected.

---

## 🏅 Honorable Mention

Special thanks to the [Jornada Dev course](https://jornadadodev.com.br/cursos/front-end/css-3-basicohttps://jornadadodev.com.br/cursos/front-end/html5) for its teachings up to Module 6.
